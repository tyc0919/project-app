    ...
    <div class="shadow bg-white flex flex-col justify-between px-4 py-4 card align-start hover:card-float-up">
        <div class="cardTop mb-8 ">
            ...
            <div class="inline-flex justify-start w-full text-sm italic person">
                <span class="">In</span>
                <span class="ml-2  person-name text-blue font-bold ellipsis">活動標題</span>
            </div>
            <div class="mt-4 ellipsis-4 text-base">
                工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述工作描述
            </div>
        </div>
